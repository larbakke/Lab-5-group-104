...
import Wall from "./wall_for_campus.js";
...
export default class MazeForCampus extends THREE.Group {
    ...
    ////////////////////////DUD
    //detect the collision with the door
    ...
    collisionWithDoor(method, position, halfSize, direction) {
        ...
        if (method != "obb-aabb") {
            if (
                ...
                this.DoorCollision(indices, [0, 0], 0, position, { x: 0.0, z: -0.475 }, halfSize, "north wall") || // Collision with north wall
                this.DoorCollision(indices, [0, 0], 1, position, { x: -0.475, z: 0.0 }, halfSize, "west wall") || // Collision with west wall
                this.DoorCollision(indices, [1, 0], 0, position, { x: 0.0, z: -0.525 }, halfSize, "south wall") || // Collision with south wall
                this.DoorCollision(indices, [0, 1], 1, position, { x: -0.525, z: 0.0 }, halfSize, "east wall") || // Collision with east wall
